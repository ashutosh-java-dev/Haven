              ...
              <div className="p-5">
                ...
                {isLowAvailability && (
                  <div className="flex items-center gap-1.5 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="size-4 text-amber-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
